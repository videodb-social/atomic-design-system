...
│   ├── logos/              # plus motion (Hyperframes-rendered MP4 organisms)
│   ├── customer-logos/
│   ├── partner-logos/
│   ├── compliance-logos/
│   └── motion/             # Pre-rendered MP4s embedded via the Motion wrapper
